    ...
    return Scaffold(
      body: ListView(children: <Widget>[
        Column(children: <Widget>[
          ...
          SizedBox(height: 15.0),
          listItem('Gift card', Theme.of(context).accentColor, Icons.account_box),
          listItem('Bank card', Theme.of(context).primaryColor.withOpacity(0.9), Icons.credit_card),
          listItem('Replacement code',Theme.of(context).accentColor, Icons.grid_on),
          listItem('Consulting collection',Theme.of(context).primaryColor.withOpacity(0.9), Icons.pages),
          listItem('Customer service',Theme.of(context).accentColor, Icons.person)
        ])
      ]),
    );
  }
